    ...
    public render() {
        return <div>
            <tr key={this.props.name}>
                <td> <img src={this.props.image} className="img-circle img-responsive" style={{ maxWidth: 100, maxHeight: 100, minHeight: 100, minWidth: 100 }}>
                </img></td>
                <td>
                    ...
                    <table>
                        <tr>
                            <td>
                                <label style={{ fontSize: 10 }}>Runs Scored</label>
                            </td>
                            <td>
                                <label style={{ fontSize: 10 }}>Wickets Taken</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
