            ...
            <div className='card text-center' style={{ backgroundColor: 'white', height: 280, margin: 10 }}>
                ...
                <div className='card-footer' style={{}} >
                    <div>
                        ...
                        <Link to={"/Stats?mid=" + (this.props.Match as Match).URL + "&mname=" + (this.props.Match as Match).Name} className="btn btn-outline-warning btn-lg" disabled={(this.props.Match as Match).Status != 'Match will start soon.' ? false : true} style={(this.props.Match as Match).Status != 'Match will start soon.' ? { pointerEvents: '', margin: '2px' } : { pointerEvents: 'none', margin:'2px' }}>chart</Link>
                    </div>
                </div>
            </div> 
        </div>;
